...
<body class="">
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3  fixed-top">
        <div class="container">
            <a href="home.php" class="navbar-brand amit" id="logo">
                WHAT 2 LEARN
            </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-row  mt-3 mb-2 justify-content-between">
                                            ...
                                            <div class="col-6 d-flex flex-row-reverse  justify-content-end nowrap ">
                                                <p class="col p-0 pt-2 m-0 justify-content-end" style="color:gray;font-weight: bold;"><i class="bi bi-pen"></i> Author: <?php echo $row['author'] ?></p>
